...
const Navbar = () => {
  return (
    <nav className='flex justify-center text-white p-5 text-2xl font-light'>
        <ul className='flex justify-between w-[40%]'>
          <Link to={"/"}>
            <li className='group text-white transition duration-300 hover:scale-125'>Home
            <span class="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-[#38bdf8]"></span>
            </li>
          </Link>
          ...
          <Link to={"/experience"}>
            <li className='group text-white transition duration-300 hover:scale-125'>Experience
            <span class="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-[#38bdf8]"></span>
            </li>
          </Link>
